...
const Projects = () => {
    ...
    const { projects, addProject, removeProject, setDefaultProject } = useProjectStore();
        ...
        <div className={styles["project-container"]}>
            <div className={styles.header}>
                ...
                <div className={styles.actions}>
                    <button type="submit" onClick={handleOpenModal}>Add Project</button>
                </div>
            </div>
                ...
                {projects.length > 0 ? (
                    projects.map((project) => (
                        <div
                            ...
                            {project.default && <div className={styles.defaultIndicator}>Default</div>}
