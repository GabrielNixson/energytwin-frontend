                                            ...
                                            <div style={{ flex: 1 }}>
                                                <CustomDropdown 
                                                    ...
                                                    onChange={(val) => {
                                                        ...
                                                        setDeviceForm({
                                                            ...deviceForm,
                                                            serial: { ...deviceForm.serial, path: val === 'custom' ? '' : val }
                                                        });
                                                    }}
                                                />
                                            </div>
                                            {(deviceForm.serial.path === '' || !serialPathOptions.some(opt => opt.id === deviceForm.serial.path && opt.id !== 'custom')) && (
                                                <input 
                                                    type="text"
                                                    placeholder="Enter custom serial path (e.g. COM5 or /dev/ttyUSB2)"
